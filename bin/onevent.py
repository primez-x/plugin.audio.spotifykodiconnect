...
# -*- coding: utf-8 -*-
"""
Onevent script for LibreSpot: called by librespot when track changes or stops.
Sends UDP event to Spotify Kodi Connect service (port 36964, distinct from service.librespot).
"""
import json
import os
import socket
